...
mod tests {
	...
	#[test]
	fn decode_lbz() {
		assert_eq!(decode(0x89230080, 0, Uarch::Ppc206B).unwrap(),
			Op::RtDRa(Mne::Lbz, Reg::Gpr(9),    128, Reg::Gpr(3)));
		assert_eq!(decode(0x88EAB004, 0, Uarch::Ppc206B).unwrap(),
			Op::RtDRa(Mne::Lbz, Reg::Gpr(7), -20476, Reg::Gpr(10)));
	}
}
