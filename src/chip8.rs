...
mod tests {
	use super::*;
	use super::super::{Disassembler, DisError};
	...
	static TEST_CASES: [TestCase; 86] = [
		...
		TestCase{ instr: 0x2000, asm: "call 0x000",       op: Op::Addr(Mne::Call, 0x000)                               },
		TestCase{ instr: 0x2423, asm: "call 0x423",       op: Op::Addr(Mne::Call, 0x423)                               },
		TestCase{ instr: 0x245C, asm: "call 0x45c",       op: Op::Addr(Mne::Call, 0x45C)                               },
		TestCase{ instr: 0x25E0, asm: "call 0x5e0",       op: Op::Addr(Mne::Call, 0x5E0)                               },
		TestCase{ instr: 0x27DB, asm: "call 0x7db",       op: Op::Addr(Mne::Call, 0x7DB)                               },
		TestCase{ instr: 0x2958, asm: "call 0x958",       op: Op::Addr(Mne::Call, 0x958)                               },
		TestCase{ instr: 0x2FFF, asm: "call 0xfff",       op: Op::Addr(Mne::Call, 0xFFF)                               },
		...
		TestCase{ instr: 0x1000, asm: "jp   0x000",       op: Op::Addr(Mne::Jp, 0x000)                                 },
		TestCase{ instr: 0x1423, asm: "jp   0x423",       op: Op::Addr(Mne::Jp, 0x423)                                 },
		TestCase{ instr: 0x145C, asm: "jp   0x45c",       op: Op::Addr(Mne::Jp, 0x45C)                                 },
		TestCase{ instr: 0x15E0, asm: "jp   0x5e0",       op: Op::Addr(Mne::Jp, 0x5E0)                                 },
		TestCase{ instr: 0x17DB, asm: "jp   0x7db",       op: Op::Addr(Mne::Jp, 0x7DB)                                 },
		TestCase{ instr: 0x1958, asm: "jp   0x958",       op: Op::Addr(Mne::Jp, 0x958)                                 },
		TestCase{ instr: 0x1FFF, asm: "jp   0xfff",       op: Op::Addr(Mne::Jp, 0xFFF)                                 },
		TestCase{ instr: 0xB000, asm: "jp   v0, 0x000",   op: Op::RegAddr(Mne::Jp, Reg::V(0), 0x000)                   },
		TestCase{ instr: 0xBD72, asm: "jp   v0, 0xd72",   op: Op::RegAddr(Mne::Jp, Reg::V(0), 0xD72)                   },
		TestCase{ instr: 0xBFFF, asm: "jp   v0, 0xfff",   op: Op::RegAddr(Mne::Jp, Reg::V(0), 0xFFF)                   },
		...
		TestCase{ instr: 0xA000, asm: "ld   i, 0x000",    op: Op::RegAddr(Mne::Ld, Reg::I, 0x000)                      },
		TestCase{ instr: 0xA69E, asm: "ld   i, 0x69e",    op: Op::RegAddr(Mne::Ld, Reg::I, 0x69E)                      },
		TestCase{ instr: 0xAFFF, asm: "ld   i, 0xfff",    op: Op::RegAddr(Mne::Ld, Reg::I, 0xFFF)                      },
		...
		TestCase{ instr: 0x0000, asm: "sys  0x000",       op: Op::Addr(Mne::Sys, 0x000)                                },
		TestCase{ instr: 0x0010, asm: "sys  0x010",       op: Op::Addr(Mne::Sys, 0x010)                                },
		TestCase{ instr: 0x00DF, asm: "sys  0x0df",       op: Op::Addr(Mne::Sys, 0x0DF)                                },
		TestCase{ instr: 0x00F0, asm: "sys  0x0f0",       op: Op::Addr(Mne::Sys, 0x0F0)                                },
		TestCase{ instr: 0x00FF, asm: "sys  0x0ff",       op: Op::Addr(Mne::Sys, 0x0FF)                                },
